...
$(function () {
    $(".card-area .card-item").mousemove(function () {
    ...
    $(".carousel-indicators li").click(function () {
        ...
        i = index;
        $(".carousel-inner .item_banner").eq(index).stop().show(500).siblings().stop().hide(500);
    });
    ...
    function move() {
        ...
        i++;
        $(".carousel-indicators li").eq(i).addClass("active").siblings().removeClass("active");
        $(".carousel-inner .item_banner").eq(i).show(500).siblings().hide(500);
    ...
    $(window).resize(function () {
        ...
        if ($(window).width() < 767) {
            $(".subbit").css("right", "80px");
        } else {
            $(".subbit").css("right", "0");
        }

        if ($(window).width() < 1450) {
            $(".subbit input[type=text]").hide();
        } else {
            $(".subbit input[type=text]").show();
        }
    });

    $(".login_list ol li input[type!=submit]").focus(function () {
        $(this).css("border-color", "#0ba1e4")
    }).blur(function () {
    ...
    function $resize(page) {
        let $top = ($(window).height() - page.height()) / 2;
        let $left = ($(window).width() - page.width()) / 2;
        page.css({"top": $top, "left": $left});
        page.css({"top": $top, "left": $left});
    };
    ...
    function login_signup(page) {
        $(".login_page input:not(.button)").val("");
        $(".signup_page input:not(.button)").val("");
        $(".msg1").html("");
        $(".msg2").html("");
        let $top = ($(window).height() - page.height()) / 2;
        let $left = ($(window).width() - page.width()) / 2;
        page.show().css({"top": $top, "left": $left});
        $(".background").show();
    }
